...
\begin{mathpar}
  \inferrule[4d]{
    \Gamma \vdash c_1 \equiv c_1' : k_1 \quad \Gamma \vdash c_2 \equiv c_2' : k_2
  }{
    \Gamma \vdash \langle c_1, c_2 \rangle \equiv \langle c_1', c_2' \rangle : k_1 * k_2
  } \and

  \inferrule[4e]{
    \Gamma \vdash c \equiv c' : k_1 * k_2
  }{
  ...
  \inferrule[4f]{
    ...
    \Gamma \vdash \pi_2 \ c \equiv \pi_2 \ c' : k_2
  } \and
  ...
  \inferrule[4i]{
    \Gamma \vdash \pi_1 \ c \equiv \pi_1 c' : k_1 \quad \Gamma \vdash \pi_2 \ c \equiv \pi_2 \ c' : k_2
  }{
    \Gamma \vdash c \equiv c' : k_1 * k_2
  }
\end{mathpar}
